...
public class Codegen extends VisitorAdapter{
	...
	public LlvmValue visit(ArrayAssign n){
	    ...
	    // Corrige primeira posição para guardar tamanho
	...
	public LlvmValue visit(IdentifierExp n){
		...
		if(addr.type.toString().contains("%class.")) {
